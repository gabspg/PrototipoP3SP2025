...
public class MantenimientoMarca extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeCombos() { //no se hace cambio
        ...
        for (int i = 0; i < marcas.size(); i++) {
            cbox_empleado.addItem(marcas.get(i).getIdMarca());
        }
    }
    //
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("Nombre_marcas");
        modelo.addColumn("Descripcion_marca");
        modelo.addColumn("Estado");
        MarcaDAO marcasDAO = new MarcaDAO();
        List<Marca> marcas = marcasDAO.select(); //vendedores=alumnos, alumno=vendedor
        tablaMarca.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < marcas.size(); i++) {
            dato[0] = marcas.get(i).getIdMarca();
            dato[1] = marcas.get(i).getNombre_marca();
            dato[2] = marcas.get(i).getDescripcion_marca();
    ...
    public void buscarMarca() {
        ...
        marcaAConsultar.setIdMarca(txtbuscado.getText());
        marcaAConsultar = marcaDAO.query(marcaAConsultar);
        txtidMarca.setText(marcaAConsultar.getIdMarca());
        txtNombre.setText(marcaAConsultar.getNombre_marca());
        txtDescripcion.setText(marcaAConsultar.getDescripcion_marca());
    ...
    private void initComponents() {
        ...
        tablaMarca.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(txtidMarca, javax.swing.GroupLayout.DEFAULT_SIZE, 263, Short.MAX_VALUE))
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
       ...
       MarcaDAO marcaDAO = new MarcaDAO();
        ...
        marcaAEliminar.setIdMarca(txtbuscado.getText());
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        marcaAActualizar.setIdMarca(txtidMarca.getText());
        marcaAActualizar.setNombre_marca(txtNombre.getText());
        marcaAActualizar.setDescripcion_marca(txtDescripcion.getText());
        
        marcaDAO.insert(marcaAActualizar);
        llenadoDeTablas();
